...
<body class="is-preload">
    ...
    <div id="wrapper" class="fade-in">
        ...
        <div id="main">
            ...
            <article>
                <header>
                    <h2>CYBER TÜRK'ÜN HİKAYESİ!</h2>
                </header>
                <img src="images/im2.jpg" width="1000px" height="500px" alt="" />
                <p>CyberTürk, yalnızca bir blog olarak değil, bir duruş olarak doğdu. Bu dijital çağda, bilgiye ulaşmak kolay ama doğru bilgiye ulaşmak zordur. Hele ki bu bilgi siber güvenlik gibi derin ve teknik bir alandaysa, çoğu kişi nereden başlayacağını bile bilemez. İşte CyberTürk tam da bu boşluğu doldurmak için ortaya çıktı.
                    Yerli kaynak eksikliği, teknik içeriklerin karmaşıklığı ve dijital dünyadaki artan tehditler; bizi, bu alanda sade, anlaşılır ve Türkçe içerik üreten bir mecra kurmaya itti. Çünkü biz, dışa bağımlı kalmadan kendi dijital savunmamızı inşa etmenin bir kültür meselesi olduğuna inanıyoruz.
                    CyberTürk; sadece zafiyet anlatan, araç tanıtan bir blog değil. Aynı zamanda bir bilinç uyanışı, bir siber farkındalık hareketidir. Burada okuduğun her yazı, kodun her satırı, anlatılan her zafiyet; birilerinin güvenliğine katkı sağlar. Çünkü biz inanıyoruz ki bilgi paylaşıldıkça güçlenir.
                    Bu blog, merak eden herkes için bir başlangıç noktasıdır. Yeni başlayan da burada kendini bulur, ileri düzey olan da. CyberTürk, dijital vatan savunmasında Türk aklının sesi olmaya devam edecek. Çünkü bu bizim hikayemiz.
                </p>
            </article>
            <!-- Footer -->
            <footer>
