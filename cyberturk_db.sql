...
--
ALTER TABLE `mesajlar`
  ADD CONSTRAINT `mesajlar_ibfk_1` FOREIGN KEY (`gonderen_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `mesajlar_ibfk_2` FOREIGN KEY (`alan_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
